...
public class Level3 extends AppCompatActivity {
   ...
   public int count=0;//счетчик правильных ответов
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Устанавливаем картинку в диалоговре окно

        //Устанавливаем картинку
        ImageView background =(ImageView)findViewById(R.id.background);
        background.setImageResource(R.drawable.twolevel_two);

        TextView tv= findViewById(R.id.task);
        tv.setText(R.string.level_tree);
...
//вызов диалогового окна в начале игры
        ...
        dialogfonEnd.setBackgroundResource(R.drawable.dialogend2);
        ...
        textdescriptionEnd.setText(R.string.Level_twoEnd2);
        ...
        final Animation a= AnimationUtils.loadAnimation(Level3.this, R.anim.alpha);//Теперь через переменную а можно обратиться к файлу с анимацией и анимация будет загружена в java
        //Подключаем анимацию- конец

        numLeft=random.nextInt(array.images2.length-1);//генерирум случайное число от 0 до 18
        image_left.setImageResource(array.images2[numLeft]);
        //достаем из массива картинку
        text_let.setText(array.texts2[numLeft]);// Достаем из массива текст

        numRight=random.nextInt(array.images2.length);//генерирум случайное число от 0 до 18
        //Цикл
        while(array.strong[numLeft]==array.strong[numRight]){
            numRight=random.nextInt(array.images2.length-1);
        }
        image_right.setImageResource(array.images2[numRight]);
        //достаем из массива картинку
        text_right.setText(array.texts2[numRight]);//Достаем из массиа текст
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if(event.getAction()==MotionEvent.ACTION_DOWN){
                    ...
                    if(count==16){
                        ...
                        numLeft=random.nextInt(array.images2.length-1);//генерирум случайное число от 0 до 9
                        image_left.setImageResource(array.images2[numLeft]);
                        //достаем из массива картинку
                        text_let.setText(array.texts2[numLeft]);// Достаем из массива текст

                        numRight=random.nextInt(array.images2.length);//генерирум случайное число от 0 до 9
                        //Цикл
                        while(array.strong[numLeft]==array.strong[numRight]){
                            numRight=random.nextInt(array.images2.length-1);
                        }
