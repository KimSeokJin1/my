...
//вызов диалогового окна в начале игры
        ...
        final Animation a= AnimationUtils.loadAnimation(Level2.this, R.anim.alpha);//Теперь через переменную а можно обратиться к файлу с анимацией и анимация будет загружена в java
